      ...
      {realtime && (
        <>
          ...
          {section("Balance Area", "from-emerald-400 to-teal-400", [
            ...
            <StatCard key="kyc-resubmission" icon={CreditCard} label="Total KYC Resubmission USD" value={`$${toAmount(realtime.total_kyc_resubmission_usd).toLocaleString()}`} delay={0.17} iconColor="text-cyan-400" />,
