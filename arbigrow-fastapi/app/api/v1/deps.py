    ...
    if not getattr(user, "is_admin", False):
        ...
        if approval == "rejected":
            raise HTTPException(
                ...
                detail={
                    "code": "USER_REJECTED",
                    "message": "Your account has been rejected by the OFA Management. Please contact the OFA Support Team for further assistance.",
                },
            )
        if approval == "pending":
            raise HTTPException(
                ...
                detail={
                    ...
                    "message": "Your account is pending approval by the OFA Management. Please wait for admin approval before logging in.",
                },
            )
