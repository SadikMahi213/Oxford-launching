...
# Only these categories appear in Transaction History.
TRANSACTION_STREAM_CATEGORIES = frozenset({
    "deposit", "withdrawal", "kyc_fee", "kyc_resubmission_fee", "refund", "package_investment",
})
...
_WT_CATEGORY = {
    ...
    "kyc_resubmission_fee_hold": ("kyc_resubmission_fee", "deduction", "debit", "held"),
    "kyc_resubmission_fee_release": ("kyc_resubmission_fee", "deduction", "credit", "completed"),
}
