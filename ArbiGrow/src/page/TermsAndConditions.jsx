  ...
  const sections = useMemo(() => [
    {
      ...
      icon: AlertCircle,
      content: [t('terms.sections.s1_c1'), t('terms.sections.s1_c2'), t('terms.sections.s1_c3')],
    },
    {
      title: t('terms.sections.s2_title'),
      icon: Shield,
      content: [t('terms.sections.s2_c1'), t('terms.sections.s2_c2')],
    },
    {
      title: t('terms.sections.s3_title'),
      icon: Lock,
      content: [t('terms.sections.s3_c1'), t('terms.sections.s3_c2')],
    },
    {
      title: t('terms.sections.s4_title'),
      icon: Wallet,
      content: [t('terms.sections.s4_c1'), t('terms.sections.s4_c2')],
    },
    {
      title: t('terms.sections.s5_title'),
      icon: ShieldOff,
      content: [t('terms.sections.s5_c1')],
    },
    {
      title: t('terms.sections.s6_title'),
      icon: FileText,
      content: [t('terms.sections.s6_c1')],
    },
  ], [t]);
        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-3">{t('terms.questionsTitle')}</h3>
