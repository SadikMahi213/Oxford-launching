...
class DueDiligenceDocumentController extends CrudController {
    protected $model = \App\Models\DueDiligenceDocument::class;
    protected $viewPrefix = 'documents';
    protected $routePrefix = 'documents';
    protected $title = 'Document';
    protected $uploadFields = [];
    protected function rules($id=null): array {
        return match('DueDiligenceDocument') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('DueDiligenceDocument'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('DueDiligenceDocument', ['DueDiligenceDocument'])) {
