...
class DevelopmentMilestoneController extends CrudController {
    protected $model = \App\Models\DevelopmentMilestone::class;
    protected $viewPrefix = 'milestones';
    protected $routePrefix = 'milestones';
    protected $title = 'Milestone';
    protected $uploadFields = ['image'];
    protected function rules($id=null): array {
        return match('DevelopmentMilestone') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('DevelopmentMilestone'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('DevelopmentMilestone', ['DueDiligenceDocument'])) {
