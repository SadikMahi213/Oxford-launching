...
class CompetitorController extends CrudController {
    protected $model = \App\Models\Competitor::class;
    protected $viewPrefix = 'competitors';
    protected $routePrefix = 'competitors';
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('Competitor'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('Competitor', ['DueDiligenceDocument'])) {
