...
class FinancialScenarioController extends CrudController {
    protected $model = \App\Models\FinancialScenario::class;
    protected $viewPrefix = 'financials';
    protected $routePrefix = 'financials';
    protected $title = 'Financial Scenario';
    protected $uploadFields = [];
    protected function rules($id=null): array {
        return match('FinancialScenario') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('FinancialScenario'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('FinancialScenario', ['DueDiligenceDocument'])) {
