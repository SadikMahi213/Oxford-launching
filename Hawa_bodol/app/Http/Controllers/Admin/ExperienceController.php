...
class ExperienceController extends CrudController {
    ...
    protected $viewPrefix = 'experiences';
    protected $routePrefix = 'experiences';
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('Experience'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('Experience', ['DueDiligenceDocument'])) {
