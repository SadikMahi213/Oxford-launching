...
class MasterplanZoneController extends CrudController {
    protected $model = \App\Models\MasterplanZone::class;
    protected $viewPrefix = 'masterplan';
    protected $routePrefix = 'masterplan';
    protected $title = 'Masterplan Zone';
    protected $uploadFields = ['image'];
    protected function rules($id=null): array {
        return match('MasterplanZone') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('MasterplanZone'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('MasterplanZone', ['DueDiligenceDocument'])) {
