...
class SiteSettingController extends CrudController {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('SiteSetting'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('SiteSetting', ['DueDiligenceDocument'])) {
