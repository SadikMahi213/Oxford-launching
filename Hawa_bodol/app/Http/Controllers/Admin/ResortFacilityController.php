...
class ResortFacilityController extends CrudController {
    protected $model = \App\Models\ResortFacility::class;
    protected $viewPrefix = 'facilities';
    protected $routePrefix = 'facilities';
    protected $title = 'Facility';
    protected $uploadFields = ['image'];
    protected function rules($id=null): array {
        return match('ResortFacility') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('ResortFacility'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('ResortFacility', ['DueDiligenceDocument'])) {
