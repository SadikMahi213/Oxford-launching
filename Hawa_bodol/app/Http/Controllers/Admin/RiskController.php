...
class RiskController extends CrudController {
    protected $model = \App\Models\Risk::class;
    protected $viewPrefix = 'risks';
    protected $routePrefix = 'risks';
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('Risk'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('Risk', ['DueDiligenceDocument'])) {
