...
class MarketStatisticController extends CrudController {
    protected $model = \App\Models\MarketStatistic::class;
    protected $viewPrefix = 'market-stats';
    protected $routePrefix = 'market-stats';
    protected $title = 'Market Statistic';
    protected $uploadFields = [];
    protected function rules($id=null): array {
        return match('MarketStatistic') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('MarketStatistic'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('MarketStatistic', ['DueDiligenceDocument'])) {
