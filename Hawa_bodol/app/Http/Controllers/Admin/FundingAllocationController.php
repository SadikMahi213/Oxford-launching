...
class FundingAllocationController extends CrudController {
    protected $model = \App\Models\FundingAllocation::class;
    protected $viewPrefix = 'funding';
    protected $routePrefix = 'funding';
    protected $title = 'Funding Allocation';
    protected $uploadFields = ['image'];
    protected function rules($id=null): array {
        return match('FundingAllocation') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('FundingAllocation'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('FundingAllocation', ['DueDiligenceDocument'])) {
