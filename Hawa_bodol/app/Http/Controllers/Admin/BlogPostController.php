...
class BlogPostController extends CrudController {
    ...
    protected $uploadFields = ['thumbnail'];
    protected function rules($id=null): array {
        return match('BlogPost') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('BlogPost'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('BlogPost', ['DueDiligenceDocument'])) {
