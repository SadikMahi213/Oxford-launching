...
class TeamMemberController extends CrudController {
    ...
    protected $viewPrefix = 'team';
    protected $routePrefix = 'team';
    protected $title = 'Team Member';
    protected $uploadFields = ['photo'];
    protected function rules($id=null): array {
        return match('TeamMember') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('TeamMember'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('TeamMember', ['DueDiligenceDocument'])) {
