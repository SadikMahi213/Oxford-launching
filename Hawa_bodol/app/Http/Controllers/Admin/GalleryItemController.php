...
class GalleryItemController extends CrudController {
    protected $model = \App\Models\GalleryItem::class;
    protected $viewPrefix = 'gallery';
    protected $routePrefix = 'gallery';
    protected $title = 'Gallery Item';
    protected $uploadFields = ['image'];
    protected function rules($id=null): array {
        return match('GalleryItem') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('GalleryItem'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('GalleryItem', ['DueDiligenceDocument'])) {
