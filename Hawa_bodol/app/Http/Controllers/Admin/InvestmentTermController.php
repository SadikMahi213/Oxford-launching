...
class InvestmentTermController extends CrudController {
    protected $model = \App\Models\InvestmentTerm::class;
    protected $viewPrefix = 'investment-terms';
    protected $routePrefix = 'investment-terms';
    protected $title = 'Investment Term';
    protected $uploadFields = [];
    protected function rules($id=null): array {
        return match('InvestmentTerm') {
    ...
    protected function handleUploads(\Illuminate\Http\Request $request, $data, $existing=null){
        if('InvestmentTerm'==='DueDiligenceDocument' && $request->hasFile('file_path')){
        ...
        } elseif(in_array('InvestmentTerm', ['DueDiligenceDocument'])) {
